...
plt.title('Cardiovascular OS ROC Curves',fontsize=18)
...
plt.show()
fig.savefig('../../Docs/images/Results/Cardiovascular_OS_ROC_Updated.png', dpi=100)
...
# plt.title('Cardiovascular OS PR Curves',fontsize=18)
...
#                if 'step' in signature(plt.fill_between).parameters
#                else {})
# plt.step(recall, precision, color=colors[5], lw=1.5, alpha=0.5,
#          where='post',label=algo_names[5]+'(AP = %0.2f)' % AP[5])

# plt.legend(loc="upper right")
# plt.show()
# fig.savefig('../../Docs/images/Results/Cardiovascular_OS_AP_Updated.png', dpi=100)