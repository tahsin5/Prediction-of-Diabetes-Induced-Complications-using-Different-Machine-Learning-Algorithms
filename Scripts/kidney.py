...
plt.title('Nephropathy ROC Curves',fontsize=20)
...
plt.show()
fig.savefig('../../Docs/images/Results/Nephropathy_ROC_Updated.png', dpi=100)
...
# plt.title('Nephropathy PR Curves',fontsize=18)
...
# plt.show()
# fig.savefig('../../Docs/images/Results/Nephropathy_AP_Updated.png', dpi=100)
