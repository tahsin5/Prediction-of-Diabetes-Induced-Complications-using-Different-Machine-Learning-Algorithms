...
plt.title('Nephropathy OS ROC Curves',fontsize=20)
...
plt.show()
fig.savefig('../../Docs/images/Results/Nephropathy_OS_ROC_Updated.png', dpi=100)
...
# plt.title('Nephropathy OS PR Curves',fontsize=18)
...
# plt.show()
# fig.savefig('../../Docs/images/Results/Nephropathy_OS_AP_Updated.png', dpi=100)